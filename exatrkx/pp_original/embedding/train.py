...
from models import ExaTrkXEmbedder, HingeLoss
...
def run_epoch(data_processor,
    ...
    for idx, data in pbar:
        ...
        loss = loss_fn(emb_head, emb_tail, labels)
...
def train():
    ...
    # model parameters
    model = ExaTrkXEmbedder(input_size=5)
    loss_fn = HingeLoss()
    ...
    # model sizes
    model_size_dict = {
        'model'   : count_parameters(model) / (1024 ** 2),
    }
